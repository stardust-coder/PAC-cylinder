...
from dataloader import load_nadalin_human_seizure
...
if __name__ == "__main__":
    ...
    patientA, patientB = load_nadalin_human_seizure() #<class 'dict'>, dict_keys(['__header__', '__version__', '__globals__', 'Fs', 'PatientA', 'PatientB'])
    fs_raw = 30000
